...
//                                 <Button size="lg" className="w-full" disabled={items.some((item) => item.productId.stock === 0)}>
//                                     Proceed to Checkout
//                                 </Button>

//                                 {items.some((item) => item.productId.stock === 0) && <p className="text-xs text-destructive text-center">Please remove out of stock items before checkout</p>}
//                             </div>
//                         </DrawerFooter>
//                     )}
//                 </div>
