...
import { Edit, Trash2, Eye, ShoppingCart, ChevronLeft, ChevronRight } from "lucide-react";
        ...
        <Card className="shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden group h-full flex flex-col gap-0 pt-0 pb-3">
            ...
            <CardFooter className="px-4">
                <div className="flex justify-between items-center w-full">
                    <span className="text-xs text-gray-500">Created: {product.createdAt ? new Date(product.createdAt).toLocaleDateString() : "N/A"}</span>

                    {/* Action Icons */}
                    <div className="flex gap-2">
                        <Button variant="default" size="icon" className="h-8 w-8" onClick={() => onView?.(product)} title="View Details">
